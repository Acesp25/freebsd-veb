# Roadmap
Features that are deliberately absent are not listed here; see non-goals in [design.md](design.md).
...
- [ ] A lower clamp on the prune period sysctl. It is currently settable to values that make no sense.
...
- [ ] Test coverage for the IPv6 case in D4.
